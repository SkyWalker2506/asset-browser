/* image-editor v0.5.3 — non-destructive in-browser mini photoshop for game sprites.
 *
    ...
    function buildUI(root) {
      const html = `
        <div class="gpc-ie-toolbar">
          ...
          <div class="gpc-ie-group">
            <button data-ie="back"   class="gpc-ie-btn-back" title="Back to Asset Browser">&#8592; Back</button>
